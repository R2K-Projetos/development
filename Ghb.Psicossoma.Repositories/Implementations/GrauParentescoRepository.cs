...
{
    public class GrauParentescoRepository : BaseRepository<GrauParentesco>, IGrauParentescoRepository
    {
        public GrauParentescoRepository(IContextDatabaseSettings settings) : base(settings)
        {
