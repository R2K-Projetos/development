...
{
    public class GrupoGuiaRepository : BaseRepository<GrupoGuia>, IGrupoGuiaRepository
    {
        public GrupoGuiaRepository(IContextDatabaseSettings settings) : base(settings)
        {
