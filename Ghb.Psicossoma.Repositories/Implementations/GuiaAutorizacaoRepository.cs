...
{
    public class GuiaAutorizacaoRepository : BaseRepository<GuiaAutorizacao>, IGuiaAutorizacaoRepository
    {
        public GuiaAutorizacaoRepository(IContextDatabaseSettings settings) : base(settings)
        {
